...
const SAMPLE_QUIZZES = [
  ...
  { id: "q_brand_5", question: "한국투자증권은 올해 처음으로 자기자본 10조를 돌파하였다. (O/X)", answer: "O", explanation: "한국투자증권은 올해 처음으로 자기자본 10조를 돌파하여, 미래에셋 다음으로 자기자본이 큰 회사이다."},
  { id: "q_brand_6", question: "뱅키스 서비스의 핵심 차별점은 비대면 편의성, 수수료 할인, 다양한 이벤트 지원에 있다. (O/X)", answer: "O", explanation: "뱅키스의 가장 큰 장점은 영업점 방문 없는 비대면 편의성, 저렴한 수수료, 다양한 프로모션/이벤트가 차별성이다."},
  { id: "q_brand_7", question: "뱅키스 서포터즈는 SNS 콘텐츠 제작, 캠퍼스 마케팅 기획 등 다양한 활동을 수행한다. (O/X)", answer: "O", explanation: "SNS 콘텐츠 및 캠퍼스 내 마케팅 활동이 주요 임무이다." },
];
